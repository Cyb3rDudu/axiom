...
func TestSchemaFilenameTitleCleanupSeparators(t *testing.T) {
	...
	got := SchemaFilename([]zotero.Creator{{LastName: "Autor", CreatorType: "author"}}, 2024,
...
func TestSchemaFilenameSubtitleBudget(t *testing.T) {
	...
	kept := SchemaFilename([]zotero.Creator{{LastName: "Bradford", CreatorType: "author"}}, 2017,
	...
	dropped := SchemaFilename([]zotero.Creator{{LastName: "Flew", CreatorType: "author"}}, 2012,
...
func TestSchemaFilenameGrownPatternSpringerPlus(t *testing.T) {
	...
	got := SchemaFilenameForFormat([]zotero.Creator{{LastName: "Dubs", CreatorType: "author"}}, 2024,
...
func TestSchemaFilenameGrownPatternFormatMarker(t *testing.T) {
	...
	got := SchemaFilenameForFormat([]zotero.Creator{{LastName: "Autor", CreatorType: "author"}}, 2020,
		"Titel", "application/pdf", []string{"Autor - 2020 - Titel (EPUB).epub"})
	if got != "Autor - 2020 - Titel (PDF).pdf" {
		t.Fatalf("got %q", got)
	}
	epub := SchemaFilenameForFormat([]zotero.Creator{{LastName: "Autor", CreatorType: "author"}}, 2020,
...
func TestSchemaFilenameNFCByteIdentity(t *testing.T) {
	...
	got := SchemaFilename([]zotero.Creator{{LastName: "Mu\u0308ller", CreatorType: "author"}}, 2020,
		"Gemu\u0308tlichkeit")
	...
	if again := SchemaFilename([]zotero.Creator{{LastName: "Müller", CreatorType: "author"}}, 2020, "Gemütlichkeit"); again != want {
