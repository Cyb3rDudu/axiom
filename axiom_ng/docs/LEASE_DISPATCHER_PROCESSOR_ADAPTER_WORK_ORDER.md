...
```text
AXIOM_DISPATCHER_ENABLED=false
AXIOM_DISPATCHER_WORKER_ID=<generated stable process id>
AXIOM_DISPATCHER_CONCURRENCY=1
AXIOM_DISPATCHER_LEASE=120s
AXIOM_PROCESSOR_URL=http://127.0.0.1:<port>
AXIOM_PROCESSOR_TIMEOUT=300s
AXIOM_ARTIFACT_ROOT=<configured durable derived-artifact root>
