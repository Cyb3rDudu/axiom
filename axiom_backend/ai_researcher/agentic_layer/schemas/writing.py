...
class WritingChangeSuggestion(BaseModel):
    ...
    issue_description: str = Field(default="See suggested change", description="A clear description of the issue identified (e.g., repetition, lack of clarity, missing transition).")
    suggested_change: str = Field(default="Review and improve this section", description="Specific guidance on how to address the issue or what content should be added/modified.")
