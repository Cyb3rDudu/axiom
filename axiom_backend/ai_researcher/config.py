...
MARKER_LLM_MODEL = os.getenv("MARKER_LLM_MODEL", "gpt-4o")
# Marker will use OpenAI API for vision-enhanced OCR
MARKER_LLM_API_KEY = os.getenv("OPENAI_API_KEY")
MARKER_LLM_BASE_URL = os.getenv("OPENAI_BASE_URL", "https://api.openai.com/v1")
